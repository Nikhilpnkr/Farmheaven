    ...
    tables: [
      {
        name: 'profiles',
        label: 'profiles',
        listColumns: ['id', 'full_name', 'phone', 'email', 'is_super_admin'],
      }, // PII: phone shown
      {
        name: 'orgs',
        label: 'orgs',
        listColumns: ['id', 'name', 'owner_id', 'plan', 'created_at'],
      },
      {
        name: 'farms',
        label: 'farms',
        listColumns: ['id', 'name', 'slug', 'org_id', 'total_acres'],
      },
      {
        name: 'memberships',
        label: 'memberships',
        listColumns: ['id', 'farm_id', 'user_id', 'role', 'is_active'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    tables: [
      ...
      { name: 'breeds', label: 'breeds', listColumns: ['id', 'species_code', 'label'] },
      {
        name: 'flocks',
        label: 'flocks',
        listColumns: ['id', 'farm_id', 'code', 'name', 'species_code'],
      },
      {
        name: 'animals',
        label: 'animals',
        listColumns: ['id', 'farm_id', 'tag', 'species_code', 'health_state'],
      },
      {
        name: 'animal_movements',
        label: 'animal movements',
        listColumns: ['id', 'farm_id', 'animal_id', 'from_structure_id', 'to_structure_id'],
      },
      {
        name: 'health_events',
        label: 'health events',
        listColumns: ['id', 'farm_id', 'animal_id', 'event_type', 'occurred_at'],
      },
      {
        name: 'breeding_events',
        label: 'breeding events',
        listColumns: ['id', 'farm_id', 'animal_id', 'sire_id', 'event_type'],
      },
      {
        name: 'production_events',
        label: 'production events',
        listColumns: ['id', 'farm_id', 'animal_id', 'kind', 'occurred_at'],
      },
      {
        name: 'lactation_rollups',
        label: 'lactation rollups',
        listColumns: ['id', 'farm_id', 'animal_id', 'total_milk_l'],
      },
      {
        name: 'flock_fcr_rollups',
        label: 'flock FCR rollups',
        listColumns: ['id', 'flock_id', 'period_end', 'fcr'],
      },
    ],
  },
  {
    ...
    tables: [
      { name: 'crops', label: 'crops', listColumns: ['id', 'code', 'label', 'family', 'kind'] },
      {
        name: 'crop_cycles',
        label: 'crop cycles',
        listColumns: ['id', 'farm_id', 'crop_id', 'plot_id', 'sowing_date'],
      },
      {
        name: 'soil_samples',
        label: 'soil samples',
        listColumns: ['id', 'farm_id', 'plot_id', 'sampled_at'],
      },
      {
        name: 'compost_windrows',
        label: 'compost windrows',
        listColumns: ['id', 'farm_id', 'code', 'started_at'],
      },
      {
        name: 'ipm_logs',
        label: 'IPM logs',
        listColumns: ['id', 'farm_id', 'plot_id', 'observed_at'],
      },
      {
        name: 'remote_sensing_runs',
        label: 'remote sensing runs',
        listColumns: ['id', 'farm_id', 'flight_date'],
      },
    ],
  },
  {
    ...
    tables: [
      {
        ...
        listColumns: ['id', 'farm_id', 'sku_id', 'quantity_remaining', 'received_at'],
      },
      {
        name: 'inventory_movements',
        label: 'inventory movements',
        listColumns: ['id', 'farm_id', 'lot_id', 'quantity', 'occurred_at'],
      },
  ...
  },
  {
    ...
    tables: [
      { name: 'workers', label: 'workers', listColumns: ['id', 'farm_id', 'full_name', 'phone'] }, // PII: phone shown
      {
        name: 'attendance',
        label: 'attendance',
        listColumns: ['id', 'farm_id', 'worker_id', 'check_in_at'],
      },
      {
        name: 'piece_work_logs',
        label: 'piece work logs',
        listColumns: ['id', 'farm_id', 'worker_id', 'occurred_at'],
      },
      {
        name: 'payroll_runs',
        label: 'payroll runs',
        listColumns: ['id', 'farm_id', 'period_month', 'status', 'total_net'],
      },
      {
        name: 'payslips',
        label: 'payslips',
        listColumns: ['id', 'farm_id', 'worker_id', 'payroll_run_id'],
      },
      {
        name: 'tasks',
        label: 'tasks',
        listColumns: ['id', 'farm_id', 'title', 'status', 'assigned_worker_id'],
      },
    ],
  },
  {
    ...
    tables: [
      {
        name: 'transactions',
        label: 'transactions',
        listColumns: ['id', 'farm_id', 'amount', 'occurred_at'],
      },
      {
        name: 'txn_categories',
        label: 'txn categories',
        listColumns: ['id', 'farm_id', 'label', 'txn_type'],
      },
      { name: 'cost_centers', label: 'cost centers', listColumns: ['id', 'farm_id', 'label'] },
      {
        name: 'subsidy_schemes',
        label: 'subsidy schemes',
        listColumns: ['id', 'label', 'authority'],
      },
      {
        name: 'subsidy_claims',
        label: 'subsidy claims',
        listColumns: ['id', 'farm_id', 'scheme_id', 'amount_approved'],
      },
    ],
  },
  {
    ...
    tables: [
      { name: 'products', label: 'products', listColumns: ['id', 'farm_id', 'name', 'price'] },
      {
        name: 'customers',
        label: 'customers',
        listColumns: ['id', 'farm_id', 'full_name', 'phone'],
      }, // PII: phone shown
      {
        name: 'customer_addresses',
        label: 'customer addresses',
        listColumns: ['id', 'customer_id', 'pincode'],
      },
      {
        name: 'customer_events',
        label: 'customer events',
        listColumns: ['id', 'farm_id', 'customer_id', 'kind'],
      },
      {
        name: 'orders',
        label: 'orders',
        listColumns: ['id', 'farm_id', 'customer_id', 'status', 'total'],
      },
      {
        name: 'order_items',
        label: 'order items',
        listColumns: ['id', 'order_id', 'sku_id', 'quantity'],
      },
      {
        name: 'subscriptions',
        label: 'subscriptions',
        listColumns: ['id', 'farm_id', 'customer_id', 'status'],
      },
      {
        name: 'delivery_routes',
        label: 'delivery routes',
        listColumns: ['id', 'farm_id', 'label'],
      },
    ],
  },
  {
    ...
    tables: [
      { name: 'devices', label: 'devices', listColumns: ['id', 'farm_id', 'label', 'kind'] },
      {
        ...
        listColumns: ['id', 'farm_id', 'device_id', 'queued_at'],
      },
      {
        name: 'automation_rules',
        label: 'automation rules',
        listColumns: ['id', 'farm_id', 'name'],
      },
      {
        name: 'rule_firings',
        label: 'rule firings',
        listColumns: ['id', 'farm_id', 'rule_id', 'fired_at'],
      },
    ],
  },
  {
